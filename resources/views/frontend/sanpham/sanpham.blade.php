                    ...
                    <div class="filter-widget">
                        ...
                        <ul class="filter-catagories">
                            @foreach($theloai as $t)
                                <li><a href="" class="theloai">{{$t->tentheloai}}</a></li>
                                <input type="hidden" name="giatri" value="$t->viettat">
                            @endforeach
                        </ul>
                    </div>
                    <div class="filter-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="{{$s->hinhanh}}" alt="" height="250px" width="50px">
                                    ...
                                    <div class="pi-text">
                                        ...
                                        <a href="{{Route('chitietthietbi',$s->id)}}">
                                            <h5>{{$s->tensanpham}}</h5>
                                        </a>
                                        <div class="product-price">
                                            {{number_format($s->gia,0)}} VND
                                        </div>
                                    </div>
                                </div>
                            </div>
